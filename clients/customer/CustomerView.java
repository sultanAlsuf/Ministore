...
public class CustomerView implements Observer
{
  ...
  public CustomerView( RootPaneContainer rpc, MiddleFactory mf, int x, int y )
  {
    ...
    JButton themeToggleButton = themeModeManager.createThemeToggleButton();
    themeToggleButton.setBounds(0, 0, 20, 20);  // Position in top-right corner
    ...
    mainPanel.add( thePicture );                           //  Add to canvas
    thePicture.clear();
